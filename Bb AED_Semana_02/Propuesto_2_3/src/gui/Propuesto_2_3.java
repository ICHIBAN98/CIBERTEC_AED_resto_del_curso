...
public class Propuesto_2_3 extends JFrame implements ActionListener {
	...
	public Propuesto_2_3() {
		...
		lblCelular.setBounds(150, 15, 70, 23);
		contentPane.add(lblCelular);

		txtCelular = new JTextField();
		txtCelular.setBounds(218, 15, 70, 23);
		contentPane.add(txtCelular);
		txtCelular.setColumns(10);
		
		lblSueldo = new JLabel("sueldo (S/)");
		lblSueldo.setBounds(150, 40, 70, 23);
		contentPane.add(lblSueldo);
		
		txtSueldo = new JTextField();
		txtSueldo.setBounds(218, 40, 70, 23);
	...
	//Crear e inicializar objeto tipo Empleado con datos obtenidos por la GUI
	Empleado em = new Empleado (leerNombre(),leerCodigo(),leerCelular(),leerSueldo());
	listado(em);
	
	int nuevoCel = 999888777;
	em.setNumCel(nuevoCel);
	double nuevoSueldo = em.getSueldoSoles() + 200;
	em.setSueldoSoles(nuevoSueldo);
	listado(em);
	...
	void listado(Empleado e) {
		...
		imprimir("Sueldo en soles: S/." + e.getSueldoSoles());
		imprimir("Rango de sueldo: " + e.rango());
		imprimir("");
	}
