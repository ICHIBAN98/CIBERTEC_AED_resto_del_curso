...
public class Propuesto_09_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		 ...
		 */
		imprimir("Suma de importes facturados: S/." + af.importesFacturados());
		imprimir("Importe promedio facturado: S/." + af.promedioFacturado());
		imprimir("Menor importe facturado: S/." + af.menorImporteFacturado());
		imprimir("Mayor importe facturado: S/." + af.mayorImporteFacturado());
		imprimir("Primera empresa cuyo importe facturado" + "\n" + "sea menor al importe promedio facturado: " + af.primEmpresa());
		imprimir("");
  	}
	...
	void listar() {
		...
		for (int i=0; i<af.tamanio(); i++) {
			Object[] fila = { af.obtener(i).getRuc(),
					          ...
					          af.obtener(i).getPrecioUnitario(),
