...
public class Problema_09_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("nombre primer desaprobado :  " + aa.nombrePrimerDesaprobado());
		imprimir("nombre ultimo aprobado :  " + aa.nombreUltimoAprobado());
		imprimir("nombre segundo desaprobado :  " + aa.nombreSegundoDesaprobado());
		imprimir("nombre penultimo aprobado :  " + aa.nombrePenultimoAprobado());
  	}
